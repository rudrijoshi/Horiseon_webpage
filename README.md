...
* The URL of the deployed application: https://rudrijoshi.github.io/Assignment1/

* The URL of the GitHub repository, with a unique name and a README that describes the project: https://github.com/rudrijoshi/Assignment1/, Assignment1 and a README that describe the project.
